...
CREATE TABLE `dining_table` (
  ...
  CONSTRAINT `FK_id_status_table` FOREIGN KEY (`id_status`) REFERENCES `status` (`id`)
...
CREATE TABLE `job` (
  ...
  KEY `FK_id_status_idx` (`id_status`),
  CONSTRAINT `FK_id_bill` FOREIGN KEY (`id_bill`) REFERENCES `bill` (`id`),
  ...
  CONSTRAINT `FK_id_table` FOREIGN KEY (`id_table`) REFERENCES `dining_table` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2019-05-29  9:20:53
