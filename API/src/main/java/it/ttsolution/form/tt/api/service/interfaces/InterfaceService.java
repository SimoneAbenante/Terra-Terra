...
public interface InterfaceService<E extends InterfaceEntity> {
	...
	static final String getFailMessage = "\nOggetto non trovato:\n"
	...
	static final String setFailMessage = "\nSalvataggio Oggetto non riuscito:\n"
			+ "Impossibile salvare l'oggetto specificato.\n";
	static final String setListFailMessage = "\nSalvataggio Lista non riuscito:\n"
			+ "Impossibile salvare la lista di oggetti specificati.\n";

	static final String deleteFailMessage = "\nEliminazione Oggetto non riuscita:\n"
			+ "Impossibile cancellare l'oggetto specificato.\n";
	static final String deleteAllFailMessage = "\nEliminazione Lista non riuscita:\n"
			+ "Impossibile cancellare la Lista specificata.\n";

	static final String invalidIdMessage = "\nId non valido:\n"
